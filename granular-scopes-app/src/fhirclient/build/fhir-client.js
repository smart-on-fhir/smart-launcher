...
function getSecurityExtensions(env, baseUrl) {
  ...
  var abortController2 = new AbortController(); // v2 fields are NOT available via the conformance statement, so ONLY use well-known.
...
function _authorize() {
  _authorize = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(env, params, _noRedirect) {
    var _params, redirect_uri, clientSecret, fakeTokenResponse, patientId, encounterId, client_id, target, width, height, usePKCE, usePost, _params2, iss, launch, fhirServiceUrl, redirectUri, _params2$scope, scope, clientId, completeInTarget, url, storage, serverUrl, inFrame, inPopUp, oldKey, stateKey, state, fullSessionStorageSupport, redirectUrl, extensions, redirectParams, codes, win;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            // Obtain input
            _params = params, redirect_uri = _params.redirect_uri, clientSecret = _params.clientSecret, fakeTokenResponse = _params.fakeTokenResponse, patientId = _params.patientId, encounterId = _params.encounterId, client_id = _params.client_id, target = _params.target, width = _params.width, height = _params.height, usePKCE = _params.usePKCE, usePost = _params.usePost;
...
function redirectPost(target, url, params) {
  ...
  params.forEach(function (param) {
    ...
    var value = param.substr(split[0].length + 1);
