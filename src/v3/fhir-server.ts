...
import { loginAsPatient, loginAsProvider } from "./login"
...
const fhirServer = express.Router({ mergeParams: true })
...
fhirServer.get("/auth/authorize", oauth.authorize)
...
// user login page
fhirServer.get("/login", loginAsPatient);
fhirServer.get("/login-as-provider", loginAsProvider);
