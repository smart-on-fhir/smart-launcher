...
var fhirServer = express.Router({ mergeParams: true });
...
// user login page
fhirServer.get("/login", login_1.loginAsPatient);
fhirServer.get("/login-as-provider", login_1.loginAsProvider);
